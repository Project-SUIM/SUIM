...
/**
 * HUD toggle element. Behaves like a BooleanElement but is used
 * for toggling HUD overlays. Renders nothing if the name is empty.
 */
public class HudElement extends GuiElement {
    ...
    public HudElement(
        ...
        super(parent, setting, SettingType.HUD);
    ...
    private boolean isBoxHovered() {
        ...
        double totalWidth = BOX_SIZE
                + FontUtil.INSTANCE.getStringWidth(displayName)
                + 5.0;
