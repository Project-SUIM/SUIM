 ...
 */
public class MoreKB implements Feature {
    ...
    public boolean initialize() {
        try {
            ...
            hook.injectModule(moduleInstance, MoreKB.class);
            ...
            intelligentProperty = hook.createBooleanProperty("intelligent", false);
            onlyGroundProperty = hook.createBooleanProperty("only-ground", true);
    ...
    private boolean getIntelligent() {
        try {
            return (Boolean) hook.getPropertyValue(intelligentProperty);
        } catch (Exception e) {
            return false;
        }
    }
    ...
    private boolean getOnlyGround() {
        try {
            return (Boolean) hook.getPropertyValue(onlyGroundProperty);
        } catch (Exception e) {
            return true;
        }
    }
