 ...
 */
public class ArmorExceptions implements Feature {
    ...
    public boolean initialize() {
        try {
            ...
            armorExceptionsProperty = hook.createStringProperty("filter-armor", "none");

            if (!hook.injectPropertyAfter(killAuraModule, armorExceptionsProperty, "sort")) {
    ...
    private void updateExceptionsCache() {
        try {
            String exceptionsValue = (String) hook.getPropertyValue(armorExceptionsProperty);
